...
$modules = [
        "SD" => [
                "Compulsory Track Course" => ["IT Solution Architecture", "Object Oriented Programming"],
                "Track Elective" => ["Alogrithmic Thinking", "Cloud Computing and SaaS Solutions", "Foundataion of Cybersecurity", "Mobile Applications"]
        ],
        "NP" => [
                "Compulsory Track Course" => ["Introduction to Programming"],
        ...
        "CS" => [
                "Compulsory Track Course" => ["Foundation of Cybersecurity"],
...
# Do not hardcore
# output a table with the available array 

$selected_majors = $_POST['major'];
